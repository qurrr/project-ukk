...
class Authmakanan extends GetxController {
  ...
  //menampilkan db farebase ke txtfield
  Future<DocumentSnapshot<Object?>> getData(String docID) async {
    DocumentReference edRef = firestore.collection("Makanan").doc(docID);
    return edRef.get();
  }

  void editproduct(String id, String nama, String harga, String docID) async {
    DocumentReference docData = firestore.collection("Makanan").doc(docID);
    try {
      if (image != null) {
  ...
  void deleteProduct(String docId) {
    DocumentReference docRef = firestore.collection("Makanan").doc(docId);
